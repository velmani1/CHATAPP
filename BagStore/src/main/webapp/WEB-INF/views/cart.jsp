		...
		<section>
			<div class="jumbotron">
				<div class="container">
					...
					<img src="<c:url value="/resources/images/cart.gif" />"
			alt="cart">
<!-- 					<iframe src="C:\Users\Selvin.K.S\Desktop\giphy (2).gif" width="480" height="292" frameBorder="0" class="giphy-embed" allowFullScreen></iframe> -->
				</div>
			</div>
		</section>
